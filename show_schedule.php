...
//		$mail->SMTPDebug =0;   //Sets Mailer to send message using SMTP
        ...
        $mail->SMTPAuth = true;	
		$mail->IsSMTP();      //Sets the SMTP hosts of your Email hosting, this for Godaddy  //Sets default                         SMTP server port
        //Sets SMTP authentication. Utilizes the Username and Password variables
		$mail->Username = "travelbuddy454@gmail.com";					//Sets SMTP username
		$mail->Password = "shravbhav123";					//Sets SMTP password
		$mail->SMTPSecure = "tls";	
        $mail->Port = "587";//Sets connection prefix. Options are "", "ssl" or "tls"
//		$mail->From ="smartguide.mnnit@gmail.com";					//Sets the From email address for the message
        $mail->setFrom('travelbuddy454@gmail.com','Travel Buddy');
...
//    $mail->Username = 'travelbuddy454@gmail.com'; // SMTP username
//    $mail->Password = 'shravbhav123'; // SMTP password
//    $mail->SMTPSecure = 'tls'; // Enable TLS encryption, `ssl` also accepted 
//    $mail->Port = 587; // TCP port to connect to
//    //Recipients 
//    $mail->setFrom('travelbuddy454@gmail.com', 'Travel Buddy'); 
//    $mail->addAddress('shravya5320@gmail.com', 'Shravya J'); // Add a recipient 
...
<!DOCTYPE html>
		...
		<!-- Header -->
		<div class="header">
			<a href="home.php" class="logo">Travel Buddy</a>
...
<hr style="margin: 0px;"> <!-- content -->
            <div class="bg-contact3" style="background-image: url('images/pic.png');">
...
//calculates distance between two points in km's
		...
		for(i=1; i<markers.length; i++){
			...
			btn.innerHTML = loc_name[i]+" &nbsp &nbsp &nbsp Distance:"+distance[i]+" Km.";
	//		btn.setAttribute("class","btnsize");
          ...
          <script async defer
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC4cOwC8UUVMhbJi0LLpY5lfDzGfgT9XTw&callback=initMap&libraries=geometry">
            </script>
        </body>
        </html>